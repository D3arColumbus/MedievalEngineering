...
import d3arcolumbus.medEngineering.block.GenericBlock;
...
public class BlockSuperchest extends GenericBlock implements ITileEntityProvider {
    ...
    public static final ResourceLocation SUPERCHEST = new ResourceLocation(MedEngineering.MODID, "superchest");

    public BlockSuperchest() {
        super(Material.IRON);
        setRegistryName(SUPERCHEST);
        setUnlocalizedName(MedEngineering.MODID + ".superchest");
