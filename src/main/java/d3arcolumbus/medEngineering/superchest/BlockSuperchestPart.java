...
import static d3arcolumbus.medEngineering.superchest.BlockSuperchest.FORMED;

public class BlockSuperchestPart extends Block implements ITileEntityProvider {

    public static final ResourceLocation SUPERCHEST_PART = new ResourceLocation(MedEngineering.MODID, "superchest_part");

    public BlockSuperchestPart() {
        super(Material.IRON);
        setRegistryName(SUPERCHEST_PART);
        setUnlocalizedName(MedEngineering.MODID + ".superchest_part");
